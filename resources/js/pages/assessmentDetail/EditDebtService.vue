    ...
    <div class="max-w-5xl mx-auto">
      <div class="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-200">
        ...
        <div class="bg-teal-600 text-white py-4 text-center shadow-inner">
          <div class="flex items-center justify-center gap-2">
            <h1 class="text-2xl font-bold text-center">4a_Debt Service Coverage Ratio (DSCR)</h1>
            <HoverCard>
              <HoverCardTrigger>
      ...
      <div>
        ...
        <div class="grid grid-cols-12 gap-x-4 gap-y-3 items-center">
          ...
          <div class="col-span-8 lg:col-span-9 flex items-center gap-2">
            <span>:</span>
            <Input type="number" v-model="form.plafond" class="bg-orange-200 border-orange-300 w-1/3" />
          ...
          <div class="col-span-8 lg:col-span-9 flex items-center gap-2">
            <span>:</span>
            <Input type="number" step="0.01" v-model="form.interest" class="bg-orange-200 border-orange-300 w-1/3" />
        ...
        <div class="grid grid-cols-12 gap-x-4 gap-y-3 items-center">
          ...
          <div class="col-span-7 lg:col-span-8 flex items-center gap-2">
            ...
            <div class="bg-green-100 px-3 py-1.5 rounded border border-green-200 w-1/3 shadow-sm">{{
              debtService.dscr.toFixed(2) }} kali</div>
          </div>
          ...
          <div class="col-span-5 lg:col-span-4 text-sm"><Label>% Pinjaman Terhadap Batas Maksimal Pinjaman</Label></div>
          <div class="col-span-7 lg:col-span-8 flex items-center gap-2">
            <span>:</span>
            <div class="bg-green-100 px-3 py-1.5 rounded border border-green-200 w-1/3 shadow-sm">{{
              debtService.limit.toFixed(0) }}%</div>
